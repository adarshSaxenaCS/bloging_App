    ...
    <Layout>
      ...
      <div className="flex justify-between flex-col-reverse md:flex-row py-20 px-8">
          <div className="space-y-3 basis-9/12 ">
            ...
            <h3 className="text-4xl font-bold capitalize">hello, i'm <span className='text-green-500'>adarsh saxena</span> </h3>
            <p className="text-lg font-semibold">Introducing <span className='text-green-500'>Adarsh Saxena,</span> a skilled web developer with a passion for crafting beautiful</p>
